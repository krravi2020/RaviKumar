 ...
 */
 ...
 export class DriverBooking extends BookingComponent {
...
public vendornotAvil:boolean=false;
 	...
 	constructor(public titleService:Title, public fb: FormBuilder ,private bookingService:BookingService,
 		...
 		super(titleService,'Service Sathi - Driver Booking',6);
 		this.stageStates[0] = true;
 		this.expertise = 'Driver';
 		this.expertiselink = 'driver';
 		this.city = 'Raipur';
 		this.time="";
 		this.date="";
 		...
 		this.cost = 'On Visit';
 		//this.expid = '5884e53fccadb341068ef270';
		...
		this.localityService.serviceDiscription("Driver").subscribe(
...
*/
    ...
    Dissmis():void{
 	...
 	book() : void{
        ...
        bookingData.serviceName ='Driver';
	...
	onSclectTime=($event: any)=> {
     ...
     localStorage.setItem("getVendor", JSON.stringify({'locality':locality,"serviceName":"Driver"}));
