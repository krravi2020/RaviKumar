 ...
 */
 ...
 @Component({
 	...
 	templateUrl: './pandit.html',
 	styleUrls: [ '../../style.css' ],
 	providers: [OrderService,MainNavComponent ],
 	animations: animations
 })
 export class PanditBooking extends BookingComponent {
...
public vendornotAvil:boolean=false;
 	...
 	constructor(public titleService:Title, public fb: FormBuilder ,private bookingService:BookingService,
 		...
 		super(titleService,'Service Sathi - Pandit Booking',6);
 		this.stageStates[0] = true
 		this.expertise = 'Pandit';
 		this.expertiselink = 'pandit';
 		//this.city = 'Raipur';
 		...
 		this.date="";
 		//this.expid = '5884e5a9ccadb341068ef278';
		...
		this.localityService.serviceDiscription("Pandit").subscribe(
 ...
 //	alert(this.vendors.indexOf(this.requestForm.value.appointment.vendordisp));
    ...
    Dissmis():void{
 	...
 	book() : void{
        ...
        bookingData.serviceName ='Pandit';
     ...
     localStorage.setItem("getVendor", JSON.stringify({'locality':locality,"serviceName":"Pandit"}));
