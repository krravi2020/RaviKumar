 ...
 */
 ...
 @Component({
 	...
 	templateUrl: './plumber.html',
 	styleUrls: [ '../../style.css' ],
 	providers: [OrderService,MainNavComponent ],
 	animations: animations
 })
 export class PlumberBooking extends BookingComponent {
...
public vendornotAvil:boolean=false;
 	...
 	constructor(public titleService:Title, public fb: FormBuilder ,private bookingService:BookingService,
 		...
 		super(titleService,'Service Sathi - Plumber Booking',6);
 		this.stageStates[0] = true;
 		this.expertise = 'Plumber';
 		this.expertiselink = 'plumber';
 		this.city = 'Raipur';
 		this.time="";
 		this.date="";
 		...
 		this.localities = [];
 		this.cost = 'On Visit';
 		//this.expid = '5884e53fccadb341068ef26e';
		...
		this.localityService.serviceDiscription("Plumber").subscribe( descriptions => {
...
citymodelDissmis() : void{
    ...
    Dissmis():void{
 	...
 	book() : void{
        ...
        bookingData.serviceName ='Plumber';
	...
	localitySelectHandler = function(locality:Locality){
     ...
     localStorage.setItem("getVendor", JSON.stringify({'locality':locality,"serviceName":"Plumber"}));
