 ...
 */
 ...
 export class LaundryBooking extends BookingComponent {
...
public vendornotAvil:boolean=false;
 	...
 	constructor(public titleService:Title, public fb: FormBuilder ,private bookingService:BookingService,
 		...
 		super(titleService,'Service Sathi - Laundry Booking',7);
 		this.stageStates[0] = true;
 		this.expertise = 'Laundry';
 		this.expertiselink = 'laundry';
 		this.city = 'Raipur';
 		...
 		this.time="";
 		this.date="";
 		//this.expid = '5884e5a9ccadb341068ef272';
		...
		this.localityService.serviceDiscription("Laundry").subscribe(
...
*/
 ...
 book() : void{
        ...
        bookingData.serviceName ='Laundry';
	...
	onSclectTime=($event: any)=> {
     ...
     localStorage.setItem("getVendor", JSON.stringify({'locality':locality,"serviceName":"Laundry"}));
