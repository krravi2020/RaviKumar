 ...
 */
 ...
 @Component({
 	...
 	templateUrl: './home-cleaning.html',
 	styleUrls: [ '../../style.css' ],
 	providers: [OrderService,MainNavComponent ],
 	animations: animations
 })
 export class HomeCleaningBooking extends BookingComponent {
...
public vendornotAvil:boolean=false;
 	...
 	constructor(public titleService:Title, public fb: FormBuilder ,private bookingService:BookingService,
 		...
 		super(titleService,'Service Sathi - Home Cleaning Booking',6);
 		this.stageStates[0] = true;
 		this.expertise = 'Home Cleaning';
 		this.expertiselink = 'home_cleaning';
 		this.city = 'Raipur';
 		...
 		this.date="";
 		//this.expid = '5884e5a9ccadb341068ef275';
		...
		this.localityService.serviceDiscription("Home cleaning").subscribe(
...
citymodelDissmis() : void{
    ...
    Dissmis():void{
 	...
 	book() : void{
        ...
        bookingData.serviceName ='Home cleaning';
	...
	onSclectTime=($event: any)=> {
     ...
     localStorage.setItem("getVendor", JSON.stringify({'locality':locality,"serviceName":"Home cleaning"}));
