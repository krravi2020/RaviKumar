import { Component, OnInit, trigger, ViewChild,transition, style, animate  } from '@angular/core';
 ...
 */
 ...
 @Component({
 	...
 	templateUrl: './carpenter.html',
 	styleUrls: [ '../../style.css' ],
 	providers: [OrderService,MainNavComponent ],
 	animations: animations
 })
 export class CarpenterBooking extends BookingComponent {
...
public vendornotAvil:boolean=false;
 	...
 	constructor(public titleService:Title, public fb: FormBuilder ,private bookingService:BookingService,
 		...
 		super(titleService,'Service Sathi - Carpenter Booking',6);
 		this.stageStates[0] = true;
 		this.expertise = 'Carpenter';
 		this.expertiselink = 'carpenter';
 		this.city = 'Raipur';
 		...
 		//this.expid = '5884e5a9ccadb341068ef273';
		...
		this.localityService.serviceDiscription("Carpenter").subscribe(
...
citymodelDissmis() : void{
    ...
    Dissmis():void{
 	...
 	book() : void{
        ...
        bookingData.serviceName ='Carpenter';
...
localitySelectHandler = function(locality:Locality){
     ...
     localStorage.setItem("getVendor", JSON.stringify({'locality':locality,"serviceName":"Carpenter"}));
