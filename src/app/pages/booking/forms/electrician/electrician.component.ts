 ...
 */
 ...
 export class ElectricianBooking extends BookingComponent {
...
public vendornotAvil:boolean=false;
 	...
 	constructor(public titleService:Title, public fb: FormBuilder ,private bookingService:BookingService,
 		...
 		super(titleService,'Service Sathi - Electrician Booking',7);
 		this.stageStates[0] = true;
 		this.expertise = 'Electrician';
 		this.expertiselink = 'electrician';
 		this.city = 'Raipur';
 		...
 		this.date="";
 		//this.expid = '5884e53fccadb341068ef26f';
		...
		this.localityService.serviceDiscription("Electrician").subscribe(
...
*/
    ...
    Dissmis():void{
 	...
 	book() : void{
        ...
        bookingData.serviceName ='Electrician';
...
vendorSelectHandler=function(locality:Locality){
	...
	localitySelectHandler = function(locality:Locality){
     ...
     localStorage.setItem("getVendor", JSON.stringify({'locality':locality,"serviceName":"Electrician"}));
